...
public class SetHoodAngleFromNetworkTables extends Command {
    ...
    private final DoubleEntry hoodSetpointEntry;

    /** Creates a new RetractHoodCommand. */
    public SetHoodAngleFromNetworkTables(HoodSubsystem hoodSubsystem, Pose2d PoseToAimAt) {
        ...
        hoodSetpointEntry = loggingTable.getDoubleTopic("Hood Angle Setpoint").getEntry(74);
        hoodSetpointEntry.set(74);
    ...
    @Override
    public void execute() {
        hoodSubsystem.setHoodMotorVoltage(hoodSubsystem.closedLoopCalculate(hoodSetpointEntry.get()));
