...
public class SetRobotRelativeTurretRotation extends Command {

    private final TurretSubsystem turretSubsystem;
    private final Rotation2d targetRotation;

    /** Creates a new SetRobotRelativeTurretRotation. */
    public SetRobotRelativeTurretRotation(TurretSubsystem turretSubsystem, Rotation2d targetRotation) {
