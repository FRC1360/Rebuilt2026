...
/**
 * Swerve-mode passing shot: sets hood + flywheel from SOTM-compensated distance
 ...
 */
public class SetShooterForSwervePassingCommand extends Command {
    ...
    public SetShooterForSwervePassingCommand(
    ...
    public void execute() {
        ...
        hoodSubsystem.setHoodMotorVoltage(
                hoodSubsystem.closedLoopCalculate(
                        robotState.getHoodAngleFromPassingGoalPose(
                                new Pose2d(compensatedGoalTranslation, new Rotation2d()))));
        flywheelSubsystem.setFlywheelVoltage(
                flywheelSubsystem.closedLoopCalculate(
                        robotState.getFlywheelVelocityFromPassingGoalPose(
                                new Pose2d(compensatedGoalTranslation, new Rotation2d()))));
